...
* **Retractions involving plagiarism: text—stealing or duplicating one’s own work has risen**
    + fake peer reviews occur when authors give journals email addresses that they control, allowing them to review their own manuscripts.      
    + flawed images include instances of intentional manipulation and of error
...
<IMG STYLE="position:absolute; TOP:180px; LEFT:50px; WIDTH:1000px; HEIGHT:450px" SRC="images/journaldata.png">
